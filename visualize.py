...
def get_ax(rows=1, cols=1, size=16): ###INCREASE to size = 40, to further increase resolution!!!
...
def display_images(images, titles=None, cols=4, cmap=None, norm=None,
    ...
    plt.figure(figsize=(40, 40 * rows // cols))
    i = 1
...
#             continue
        ...
        for verts in contours:
            ...
            ax.add_patch(p)
    fig = ax.imshow(masked_image)#ax.imshow(masked_image.astype(np.uint8))
...
def draw_box(image, box, color):
    ...
    ######drawing box of 1-pixel width:
#    y1, x1, y2, x2 = box
#    image[y1:y1, x1:x2] = color 
#    image[y2:y2, x1:x2] = color
#    image[y1:y2, x1:x1] = color
#    image[y1:y2, x2:x2] = color
#    return image


def display_top_masks(image, mask, class_ids, class_names, limit= None): #limit=4
